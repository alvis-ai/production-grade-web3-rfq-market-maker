...
- The fresh observed balance and block enter the Redis/Valkey versioned read/evaluate/CAS protocol and exact-integer Lua commit defined by ADR-0023. Redis remains the cross-replica admission authority; PostgreSQL remains the durable audit/query projection.
