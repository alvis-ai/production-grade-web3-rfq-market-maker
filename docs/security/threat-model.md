...
| Redis exposure data loss or stale hot state | Lost aggregates or an inventory refresh gap understates signed liability | AOF, replica `WAIT`, bounded backlog, immutable inventory/valuation snapshots, stale-state rejection, expiry grace, stopped-admission epoch recovery and signer-audit reconciliation |
