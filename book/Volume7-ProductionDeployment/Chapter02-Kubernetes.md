...
- Every API, hedge, analytics, and reconciliation rollout runs the same migration init container. Migration 005 creates the quote-scoped revision queue and replaces permanent quote uniqueness with one-canonical-settlement uniqueness before any reconciliation worker becomes ready.
