...
- `rfq_portfolio_delta_soft_breaches_total` counts newly accepted reservations above a reviewed gross or net delta soft limit; any increase requires inventory and hedge review before a hard limit starts rejecting quotes
- `rfq_quote_paused`
