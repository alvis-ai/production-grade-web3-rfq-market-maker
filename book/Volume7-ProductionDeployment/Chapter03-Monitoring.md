...
- `rfq_quote_rejections_total` with bounded `reason`; alert separately on `TREASURY_LIQUIDITY_INSUFFICIENT`, `PORTFOLIO_VAR_LIMIT_EXCEEDED`, `USD_REFERENCE_DEPEG` and `RISK_ENGINE_UNAVAILABLE`
- `rfq_quote_paused`
