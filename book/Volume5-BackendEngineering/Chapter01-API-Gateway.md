...
- 暴露 `POST /quote`、`POST /submit`、`GET /quote/:id`、`GET /health`、`GET /metrics`。
...
测试 request validation、error mapping、rate limit、health、metrics 和 `/quote` 路由。
