...
测试 approved path、risk rejected、pricing failure、quote store failure、signer failure、persistence failure、terminal quote status invariants、signed quote persistence validation、runtime config fail-fast 和 metrics。
