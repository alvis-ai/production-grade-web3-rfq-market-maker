...
ALTER TABLE quotes
  ADD COLUMN volatility_premium_bps INTEGER,
  ADD COLUMN hedge_cost_bps INTEGER;

-- Quotes signed before formula-v3 have no finer-grained attribution to recover.
UPDATE quotes
SET volatility_premium_bps = 0,
    hedge_cost_bps = 0
