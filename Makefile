...
help:
	...
	@echo "  quote-exposure-ledger-bootstrap Initialize one reviewed empty Redis ledger epoch"
	@echo "  quote-exposure-redis-integration-check Verify exact atomic quote limits against Redis"
	@echo "  quote-exposure-ledger-integration-check Verify Redis quote admission mirrors to PostgreSQL"
...
quote-exposure-ledger-bootstrap: backend-build
	@node scripts/quote-exposure-ledger-bootstrap.mjs

quote-exposure-integration-check: backend-build
	@node scripts/quote-exposure-integration-check.mjs

quote-exposure-redis-integration-check: backend-build
	@node scripts/quote-exposure-redis-integration-check.mjs

quote-issuance-integration-check: backend-build
	@node scripts/quote-issuance-redis-integration-check.mjs

quote-admission-integration-check: backend-build
	@node scripts/quote-admission-redis-integration-check.mjs

quote-exposure-ledger-integration-check: backend-build
	@node scripts/quote-exposure-ledger-integration-check.mjs
