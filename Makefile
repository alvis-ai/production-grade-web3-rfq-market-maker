.PHONY: help docs-check tree workspace-check skeleton-check backend-build backend-typecheck sdk-typecheck frontend-build typescript-check contract-build contract-test smoke-api
