...
assertContains(helmHedgeDeployment, [
  ...
  "name: RFQ_BINANCE_BASE_URL",
  "env.RFQ_BINANCE_BASE_URL is required for shared API/worker venue rules",
  "name: RFQ_BINANCE_REQUEST_TIMEOUT_MS",
  "name: RFQ_BINANCE_SYMBOL_RULES_MAX_AGE_MS",
  "env.RFQ_BINANCE_SYMBOL_RULES_MAX_AGE_MS is required for shared API/worker venue rules",
